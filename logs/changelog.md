...
| 2026-04-01 | references/web-capture-detection | Created shared detection rules (extracted from Cowork inbox-sort + note-rename) |
...
| 2026-04-01 | tag-manage | Initial — audit + suggest tags (consolidated from 3 Cowork skills) |
| 2026-04-01 | references/tag-convention | Created shared tag convention reference |
| 2026-04-01 | **Phase 2 complete** | 7/10 skills done. Phase 3 (social-post, social-scrape, research-report) blocked on Cowork sources |
